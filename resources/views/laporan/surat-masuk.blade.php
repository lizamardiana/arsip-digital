...
<body>
    <div class="container">
        ...
        <div class="no-data">
            ...
            <h4>Tidak Ada Data Surat Masuk</h4>
            <p>Tidak ditemukan surat masuk pada periode yang dipilih.</p>
        ...
        @if($data->count() > 0)
        <div class="footer">
            <p>Total Surat Masuk: <strong>{{ $data->count() }}</strong></p>
