                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="search" name="search" 
                                       value="{{ request('search') }}" placeholder="Cari nomor surat, pengirim, perihal...">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $loop->iteration + ($suratMasuk->currentPage() - 1) * $suratMasuk->perPage() }}</td>
                                <td>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{ route('surat-masuk.show', $item) }}" 
                                        ...
                                        @if($item->file_path)
                                        <a href="{{ route('surat-masuk.download', $item) }}" 
                                        ...
                                        <form action="{{ route('surat-masuk.destroy', $item) }}" method="POST" 
                                            ...
                                            <button type="submit" class="btn btn-danger btn-delete" 
                                                    title="Hapus" data-item-name="surat masuk">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <div class="text-muted">
                        Menampilkan {{ $suratMasuk->firstItem() }} hingga {{ $suratMasuk->lastItem() }} 
                        dari {{ $suratMasuk->total() }} entri
                    </div>
                    <div>
                        {{ $suratMasuk->links() }}
                    </div>
