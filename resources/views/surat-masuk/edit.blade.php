...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('surat-masuk.show', $suratMasuk) }}">Detail</a></li>
    <li class="breadcrumb-item active">Edit</li>
@endsection

@section('page-actions')
    <a href="{{ route('surat-masuk.show', $suratMasuk) }}" class="btn btn-secondary">
...
<div class="row mx-3"> <!-- Tambahkan margin kiri kanan -->
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('surat-masuk.update', $suratMasuk) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    @csrf
                    @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">
                                    @if($suratMasuk->file_path)
                                        File saat ini: {{ $suratMasuk->file_name }}
                                    @else
                                        Belum ada file
                                    @endif
                                </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="ringkasan" name="ringkasan" rows="3">{{ old('ringkasan', $suratMasuk->ringkasan) }}</textarea>
                    </div>
